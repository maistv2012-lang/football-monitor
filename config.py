...
def load_config() -> dict[str, Any]:
    ...
    return {
        ...
        "instagram_auto_download": enabled("INSTAGRAM_AUTO_DOWNLOAD", "true"),
        "instagram_fallback_to_manual_link": enabled("INSTAGRAM_FALLBACK_TO_MANUAL_LINK", "true"),
        "instagram_use_cookies": enabled("INSTAGRAM_USE_COOKIES", "false"),
